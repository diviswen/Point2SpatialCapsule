...
def retrival_results(train_feature_file, train_label_file, test_feature_file, test_label_file, save_dir):
    if not os.path.exists(save_dir):
        os.makedirs(save_dir)
    #generate_distance_test2test(train_feature_file, os.path.join(save_dir, "train2train_euclidean.npy"))
    generate_distance_test2test(test_feature_file, os.path.join(save_dir, "test2test_euclidean.npy"))
...
def PR_modelnet40():
    root = "/home/liuxinhai/pointnet2/retrieval/modelnet10"
    P_test2test, R_test2test, auc_test2test = PR_test2test(os.path.join(root, "modelnet10_test_set_hs200_16.npy"), os.path.join(root, "test_label.npy"), save_prefix='lxh_modelnet10_test2test')
...
if __name__ == '__main__':
    ...
    root = "/home/liuxinhai/pointnet2/retrieval/modelnet10/"
    #root = "/home/wangxiyang/tmp/"
    retrival_results(os.path.join(root, "modelnet10_test_set_hs200_16.npy"),
                     os.path.join(root, "test_label.npy"),
                     os.path.join(root, "modelnet10_test_set_hs200_16.npy"),
                     os.path.join(root, "test_label.npy"),
                     save_dir="./lxh/modelnet10/")
    #PR_modelnet40()
